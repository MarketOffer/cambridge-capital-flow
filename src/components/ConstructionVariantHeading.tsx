...
const ConstructionVariantHeading = () => {
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <FadeIn delay={0.1}>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
            Our renovations are delivered by our founder's Cambridge construction
            business — a local team aligned with our long-term goals. They build
            to last, and because they built it, ongoing maintenance is fast and
            efficient.
          </p>
        </FadeIn>
...
export default ConstructionVariantHeading;
