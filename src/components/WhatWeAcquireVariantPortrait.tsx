...
const WhatWeAcquireVariantPortrait = () => (
  <section className="px-6 py-28 md:px-10 md:py-36">
    <div className="mx-auto max-w-5xl">
      ...
      {/* Timeline + portrait photo side by side, photo aligns top-to-bottom with timeline */}
      <div className="mt-16 flex flex-col gap-12 lg:flex-row lg:items-stretch lg:gap-16">
        {/* Timeline */}
        ...
        {/* Portrait photo — stretches to match timeline height */}
        <FadeIn delay={0.3}>
          <div className="w-full overflow-hidden rounded-2xl border border-border lg:w-72 xl:w-80 self-stretch">
...
export default WhatWeAcquireVariantPortrait;
