  ...
  <section className="px-6 pt-10 pb-20 md:px-10 md:pt-14 md:pb-28" style={{ backgroundColor: "rgba(163, 196, 188, 0.08)" }}>
    <div className="mx-auto max-w-5xl">
      ...
      <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {/* Position 1: Pure photo card */}
        <FadeIn delay={0.15}>
          <div className="h-full min-h-[220px] overflow-hidden rounded-2xl border border-border">
            <img src={heroBg} alt="Cambridge aerial view" className="h-full w-full object-cover" />
          </div>
        </FadeIn>

        {/* Positions 2–6: All 5 stat cards shifted */}
        {stats.map((stat, i) => (
...
export default CambridgeVariantPhotoFirst;
