...
const CambridgeVariantPhotoStrip = () => (
  <section className="px-6 pt-10 pb-20 md:px-10 md:pt-14 md:pb-28" style={{ backgroundColor: "rgba(163, 196, 188, 0.08)" }}>
    <div className="mx-auto max-w-5xl">
      <p className="mb-2 font-sans text-xs font-semibold uppercase tracking-[0.2em] text-primary">Variant D — Photo Strip</p>
      <FadeIn>
      ...
      <FadeIn delay={0.15}>
        <div className="mt-10 aspect-[21/5] w-full overflow-hidden rounded-xl">
          <img src={heroBg} alt="Cambridge skyline" className="h-full w-full object-cover object-center" />
        </div>
      </FadeIn>
...
export default CambridgeVariantPhotoStrip;
