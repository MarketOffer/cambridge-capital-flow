...
const WhatWeAcquireVariantStripBelow = () => (
  <section className="px-6 py-28 md:px-10 md:py-36">
    <div className="mx-auto max-w-5xl">
      ...
      {/* Full-width photo strip below */}
      <FadeIn delay={0.5}>
        <div className="mt-16 overflow-hidden rounded-2xl border border-border">
          <img src={blockPhoto} alt="Cambridge block of flats" className="h-48 w-full object-cover md:h-64" />
        </div>
      </FadeIn>
    </div>
  </section>
...
export default WhatWeAcquireVariantStripBelow;
