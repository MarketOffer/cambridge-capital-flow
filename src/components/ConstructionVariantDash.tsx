      ...
      <div className="mx-auto max-w-5xl">
        ...
        <FadeIn delay={0.1}>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
            Our renovations are delivered by our founder's construction
            business&nbsp;— <em className="not-italic font-semibold text-foreground">25+ years building in Cambridge</em>.
          </p>
        </FadeIn>
        <FadeIn delay={0.15}>
...
export default ConstructionVariantDash;
